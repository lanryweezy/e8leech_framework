...
# from e8leech.core.leech_lattice import LeechLattice, construct_leech_lattice_basis
# from e8leech.core.e8_lattice import babai_nearest_plane
...
#     #     """
#     #     class DummyLeechLattice:
#     #         def __init__(self):
#     #             self.basis = construct_leech_lattice_basis()
#     #         def quantize(self, v):
#     #             return babai_nearest_plane(v, self.basis)
#     #         def is_valid(self, v):
#     #             coords = np.dot(v, np.linalg.inv(self.basis))
#     #             return np.allclose(coords, np.round(coords))
#     #
#     #     leech = DummyLeechLattice()
...
#     #     for q_v in q_vectors:
#     #         self.assertTrue(leech.is_valid(q_v))
